...
class TestRtkLib(unittest.TestCase):
    ...
    def test_convbin(self):
        notReconisableExample = getLibraryFolderPath('/testFiles/GunnerusBow.txt', PathEmbrasing='"')
        ubxExample = getLibraryFolderPath('/testFiles/HavfruenBow.ubx', PathEmbrasing='"')
